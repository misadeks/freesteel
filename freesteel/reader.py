...
from smartcard import Session # as sess
...
GEMALTO_NEW_CARD_ATR = str([
	59, 249, 150, 0, 0, 128, 49, 254, 69, 83,
	67, 69, 55, 32, 71, 67, 78, 51, 94
])
...
class Reader:
	...
	def __get_card(self, protocol):
		...
		session = Session()  # added sess.Session() to fix a problem
